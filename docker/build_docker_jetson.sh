...
echo "======================================"
echo ""
echo "Target: Jetson Thor (aarch64, Blackwell GB10, sm_110)"
echo "Base:   nvcr.io/nvidia/pytorch:25.08-py3 (Ubuntu 24.04 + ROS Jazzy)"
echo "Mode:   DEV"
echo ""
...
docker build \
    --build-arg TORCH_CUDA_ARCH_LIST="11.0" \
    -t "$IMAGE_TAG" \
    -f jetson.dockerfile \
    .
